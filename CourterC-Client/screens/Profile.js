  ...
  return (
    <SafeAreaView>
      {!user.id ? (
        ...
        <>
          <View
            style={tw`justify-center content-center items-center mt-4 flex flex-row`}
          >
            <Ionicons
              ...
              color="#0284c7"
            />
            <Text style={tw`ml-1 font-semibold text-blue-500`}>
              {user.username}
            </Text>
          </View>
          <View
          ...
          >
            ...
            <Text style={tw`font-bold text-slate-300 text-sm mb-1 mt-1`}>
              Balance
            </Text>
            <Text style={tw`font-bold text-slate-300 text-2xl mb-1`}>
              Rp. {user.balance}
            </Text>
