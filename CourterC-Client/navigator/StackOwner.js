...
import EditCourtCategory from "../screens/EditCourtCategory";
...
const StackOwner = () => {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen options={{ headerTitle: (props) => <Logo {...props} />, headerTitleAlign: 'center' , headerShadowVisible: false, headerLargeTitle: false}} name="EditCourt" component={EditCourt} />
      <Stack.Screen options={{ headerTitle: (props) => <Logo {...props} />, headerTitleAlign: 'center' , headerShadowVisible: false, headerLargeTitle: false}} name="EditCourtCategory" component={EditCourtCategory} />
